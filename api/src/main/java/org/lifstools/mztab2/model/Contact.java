...
public class Contact {
  ...
  public Contact id(@jakarta.annotation.Nullable Integer id) {
 ...
 @Min(1)
  ...
  public Contact affiliation(@jakarta.annotation.Nullable String affiliation) {
  ...
  @JsonProperty(value = JSON_PROPERTY_AFFILIATION, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAffiliation(@jakarta.annotation.Nullable String affiliation) {
    this.affiliation = affiliation;
  }
 ...
 @Pattern(regexp="^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,3})+$")
  ...
  public Contact orcid(@jakarta.annotation.Nullable String orcid) {
 ...
 @Pattern(regexp="^[0-9]{4}-[0-9]{4}-[0-9]{4}-[0-9]{3}[0-9X]{1}$")
  ...
  @JsonProperty(value = JSON_PROPERTY_ORCID, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOrcid(@jakarta.annotation.Nullable String orcid) {
    this.orcid = orcid;
  }
