...
import org.lifstools.mztab2.io.validators.SmallMoleculeIdConfidenceMeasureValidator;
 ...
 * @author nilshoffmann
 */
public class SmallMoleculeIdConfidenceMeasureValidatorTest {

    /**
     * Test of validateRefine method, of class SmallMoleculeIdConfidenceMeasureValidator.
     */
    @Test
    public void testValidateRefine() {
        Metadata metadata = new Metadata();
        MZTabParserContext parserContext = new MZTabParserContext();
        SmallMoleculeIdConfidenceMeasureValidator instance = new SmallMoleculeIdConfidenceMeasureValidator();
