 ...
 * @author nilshoffmann
 */
public class SmallMoleculeQuantificationUnitValidatorTest {

    /**
     * Test of validateRefine method, of class SmallMoleculeQuantificationUnitValidator.
     */
    @Test
    public void testValidateRefine() {
        Metadata metadata = new Metadata();
        MZTabParserContext parserContext = new MZTabParserContext();
        SmallMoleculeQuantificationUnitValidator instance = new SmallMoleculeQuantificationUnitValidator();
