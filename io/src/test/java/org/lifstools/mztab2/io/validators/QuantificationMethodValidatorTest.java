 ...
 * @author nilshoffmann
 */
public class QuantificationMethodValidatorTest {

    /**
     * Test of validateRefine method, of class QuantificationMethodValidator.
     */
    @Test
    public void testValidateRefine() {
        Metadata metadata = new Metadata();
        MZTabParserContext parserContext = new MZTabParserContext();
        QuantificationMethodValidator instance = new QuantificationMethodValidator();
