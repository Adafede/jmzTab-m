...
public class MsRun {
  ...
  public MsRun id(@jakarta.annotation.Nonnull Integer id) {
 ...
 @Min(1)
  ...
  public MsRun name(@jakarta.annotation.Nullable String name) {
  ...
  public MsRun location(@jakarta.annotation.Nonnull URI location) {
  ...
  @JsonProperty(value = JSON_PROPERTY_LOCATION, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setLocation(@jakarta.annotation.Nonnull URI location) {
    this.location = location;
  }

  public MsRun instrumentRef(@jakarta.annotation.Nullable Instrument instrumentRef) {
  ...
  @JsonProperty(value = JSON_PROPERTY_INSTRUMENT_REF, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInstrumentRef(@jakarta.annotation.Nullable Instrument instrumentRef) {
    this.instrumentRef = instrumentRef;
  }

  public MsRun format(@jakarta.annotation.Nullable Parameter format) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FORMAT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFormat(@jakarta.annotation.Nullable Parameter format) {
    this.format = format;
  }

  public MsRun idFormat(@jakarta.annotation.Nullable Parameter idFormat) {
  ...
  @JsonProperty(value = JSON_PROPERTY_ID_FORMAT, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setIdFormat(@jakarta.annotation.Nullable Parameter idFormat) {
    this.idFormat = idFormat;
  }

  public MsRun fragmentationMethod(@jakarta.annotation.Nullable List<@Valid Parameter> fragmentationMethod) {
  ...
  @JsonProperty(value = JSON_PROPERTY_FRAGMENTATION_METHOD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFragmentationMethod(@jakarta.annotation.Nullable List<@Valid Parameter> fragmentationMethod) {
    this.fragmentationMethod = fragmentationMethod;
  }

  public MsRun scanPolarity(@jakarta.annotation.Nullable List<@Valid Parameter> scanPolarity) {
  ...
  @JsonProperty(value = JSON_PROPERTY_SCAN_POLARITY, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setScanPolarity(@jakarta.annotation.Nullable List<@Valid Parameter> scanPolarity) {
    this.scanPolarity = scanPolarity;
  }

  public MsRun hash(@jakarta.annotation.Nullable String hash) {
  ...
  public MsRun hashMethod(@jakarta.annotation.Nullable Parameter hashMethod) {
  ...
  @JsonProperty(value = JSON_PROPERTY_HASH_METHOD, required = false)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setHashMethod(@jakarta.annotation.Nullable Parameter hashMethod) {
    this.hashMethod = hashMethod;
  }
