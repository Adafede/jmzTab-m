...
public class DatabaseSerializerTest extends AbstractSerializerTest {
    ...
    public void testSerialize() throws Exception {
        ...
        assertEqSentry(TestResources.MZTAB_VERSION_HEADER
            + MTD + TAB_STRING + Metadata.JSON_PROPERTY_DATABASE + "[1]" + TAB_STRING + "[, , no database, null]" + NEW_LINE
            + MTD + TAB_STRING + Metadata.JSON_PROPERTY_DATABASE + "[1]-prefix" + TAB_STRING + "null" + NEW_LINE
            + MTD + TAB_STRING + Metadata.JSON_PROPERTY_DATABASE + "[1]-uri" + TAB_STRING + "null" + NEW_LINE
            + MTD + TAB_STRING + Metadata.JSON_PROPERTY_DATABASE + "[1]-version" + TAB_STRING + "Unknown" + NEW_LINE
            + MTD + TAB_STRING + Metadata.JSON_PROPERTY_DATABASE + "[2]" + TAB_STRING + "[MIRIAM, MIR:00100079, HMDB, ]" + NEW_LINE
            + MTD + TAB_STRING + Metadata.JSON_PROPERTY_DATABASE + "[2]-prefix" + TAB_STRING + "hmdb" + NEW_LINE
            + MTD + TAB_STRING + Metadata.JSON_PROPERTY_DATABASE + "[2]-uri" + TAB_STRING + "http://www.hmdb.ca/" + NEW_LINE
            + MTD + TAB_STRING + Metadata.JSON_PROPERTY_DATABASE + "[2]-version" + TAB_STRING + "3.6" + NEW_LINE,
