...
public class ValidateApi extends BaseApi {
     ...
     */
    public List<ValidationMessage> validateMzTabFile(MzTab mzTab, String level, Integer maxErrors, Boolean semanticValidation) throws RestClientException {
        return validateMzTabFileWithHttpInfo(mzTab, level, maxErrors, semanticValidation).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<List<ValidationMessage>> validateMzTabFileWithHttpInfo(MzTab mzTab, String level, Integer maxErrors, Boolean semanticValidation) throws RestClientException {
        Object localVarPostBody = mzTab;
        
        // verify the required parameter 'mzTab' is set
        if (mzTab == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'mzTab' when calling validateMzTabFile");
        }
        ...
        return apiClient.invokeAPI("/validate", HttpMethod.POST, Collections.<String, Object>emptyMap(), localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
